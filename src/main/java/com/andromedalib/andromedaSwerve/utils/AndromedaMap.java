...
public class AndromedaMap {
        ...
        public static final Rotation2d mod1Angleoffset = Rotation2d.fromRotations(0.267090); //0.553
        ...
        public static final Rotation2d mod2Angleoffset = Rotation2d.fromRotations(0.346680); //3.540
        ...
        public static final Rotation2d mod3Angleoffset = Rotation2d.fromRotations(0.480225); //0.902;
        ...
        public static final Rotation2d mod4Angleoffset = Rotation2d.fromRotations(0.186279); //6.194
